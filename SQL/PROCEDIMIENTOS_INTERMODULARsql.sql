...
CREATE PROCEDURE PROCEDIMIENTO3
	@CICLO NVARCHAR(50)
AS
SELECT INICIATIVAS.TITULO,METAS.DESCRIPCION,ODS.NOMBRE,ASIGNATURA.NOMBRE_CURSO,PROFESORES.NOMBRE_PROFESOR
FROM ((((((ODS
...
WHERE ASIGNATURA.NOMBRE_CURSO=@CICLO
...
AS
    RETURN (SELECT MAX(COD_INICIATIVA) FROM INICIATIVAS) +1
